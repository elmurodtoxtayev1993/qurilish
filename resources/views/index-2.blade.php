...
@section('content')
    ...
    <section class="main-slider style2">
        <div class="slider-box">
            ...
            <div class="banner-carousel owl-theme owl-carousel">
                <!-- Slide -->
                <div class="slide">
                    <div class="image-layer lazy-image" style="background-image:url(assets/images/slides/slide-v2-1.jpg)"></div>
    ...
    <section class="service-style1-area pdtop75">
        <div class="container">
            <div class="title">
                <h1>Technology to take products from<br> an idea all the way to the end consumer.<br> <a href="#">#Request a quote.</a></h1>
            </div>
            <div class="row">
                ...
                <div class="col-xl-12">
                    <div class="project-menu-box wow fadeInUp" data-wow-delay="100ms" data-wow-duration="1500ms">
                        <ul class="project-filter clearfix post-filter has-dynamic-filters-counter">
                            <li data-filter=".filter-item" class="active"><span class="filter-text"><i class="flaticon-menu"></i>All Cases</span></li>
                            <li data-filter=".build"><span class="filter-text"><i class="flaticon-building"></i>Buildings</span></li>
                            <li data-filter=".bridge"><span class="filter-text"><i class="flaticon-modern-bridge-road-symbol"></i>Modern Bridge</span></li>
                            <li data-filter=".houses"><span class="filter-text"><i class="flaticon-house"></i>Houses</span></li>
                            <li data-filter=".interior"><span class="filter-text"><i class="flaticon-chair"></i>Interiors</span></li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="row filter-layout masonary-layout">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item build houses">
                    <div class="single-portfolio-style1">
                        <div class="img-holder">
                            <div class="inner-box">
                                <img class="lazy-image" src="assets/images/portfolio/portfolio-v1-3.jpg" alt="Awesome Image">
                                <div class="overlay-style-one">
                                    <div class="box">
                                        <div class="inner">
                                            <div class="zoom-button">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item bridge interior">
                    <div class="single-portfolio-style1">
                        <div class="img-holder">
                            <div class="inner-box">
                                <img class="lazy-image" src="assets/images/portfolio/portfolio-v1-4.jpg" alt="Awesome Image">
                                <div class="overlay-style-one">
                                    <div class="box">
                                        <div class="inner">
                                            <div class="zoom-button">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item build houses">
                    <div class="single-portfolio-style1">
                        <div class="img-holder">
                            <div class="inner-box">
                                <img class="lazy-image" src="assets/images/portfolio/portfolio-v1-5.jpg" alt="Awesome Image">
                                <div class="overlay-style-one">
                                    <div class="box">
                                        <div class="inner">
                                            <div class="zoom-button">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item build houses">
                    <div class="single-portfolio-style1">
                        <div class="img-holder">
                            <div class="inner-box">
                                <img class="lazy-image" src="assets/images/portfolio/portfolio-v1-6.jpg" alt="Awesome Image">
                                <div class="overlay-style-one">
                                    <div class="box">
                                        <div class="inner">
                                            <div class="zoom-button">
            ...
            <div class="row">
                ...
                <div class="col-xl-7 col-lg-12 col-md-12 col-sm-12">
                    <div class="single-blog-post wow fadeInUp animated" data-wow-delay="0.3s" data-wow-duration="1200ms">
                        <div class="img-holder">
                            <img class="lazy-image" src="assets/images/blog/blog-v1-1.jpg" alt="Awesome Image">
                ...
                <div class="col-xl-5 col-lg-12 col-md-12 col-sm-12">
                    <div class="single-blog-post style2 wow fadeInUp animated" data-wow-delay="0.4s" data-wow-duration="1300ms">
                        <div class="img-holder">
                            <img class="lazy-image" src="assets/images/blog/blog-v2-1.jpg" alt="Awesome Image">
                            <div class="overlay-style-one bg1"></div>
                            <div class="post-date">
                                <p><span class="flaticon-clock"></span>20/10/19</p>
                            </div>
                        ...
                        <div class="text-holder">
                            <h3 class="blog-title"><a href="blog-single.html">Sed volutpat velit purus, eget ultricies pretium orci pretium id. Quisque.</a></h3>
                        </div>
                    </div>
                    <div class="single-blog-post style2 wow fadeInUp animated" data-wow-delay="0.5s" data-wow-duration="1400ms">
                        <div class="img-holder">
                            <img class="lazy-image" src="assets/images/blog/blog-v2-2.jpg" alt="Awesome Image">
                            <div class="overlay-style-one bg1"></div>
                            <div class="post-date">
                                <p><span class="flaticon-clock"></span>20/10/19</p>
                            </div>
