...
@section('content')
    ...
    <!-- Start Main Slider -->
    <section class="main-slider style1 home_rtl">
                ...
                <div class="slide">
                    ...
                    <div class="auto-container">
                        <div class="content text-right">
                            <h2>يصنع <span>ك</span><br> منزل الاحلام</h2>
                            <h3>لدينا أعلى البناء.</h3>
                            <div class="text">
                                <p>الآن بلدي التلفزيون الآن، ومدير كرة القدم طبقة الحرة. المراجع السريرية للمطورين التيار<br> تخشى. كرة القدم يتلقى الآن البروتين ابتسامة كتلة.</p>
                            </div>
                            <div class="btns-box">
                                <a href="#" class="btn-two">إقتبسعرض</a>
                                <a class="btn-one" href="#">عرض المزيد</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="service-style1-area">
        <div class="container">
            <div class="title">
                <h1>التكنولوجيا لاتخاذ المنتجات من<br> فكرة على طول الطريق إلى المستهلك النهائي.<br> <a href="#">#اطلب اقتباس.</a></h1>
            </div>
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-4">
                    <div class="single-service-style1">
                        ...
                        <div class="text-holder">
                            <h3><a href="#">لدينا السيارات<br> الصانع</a></h3>
                            <p>الآن ليس لديهم الموز آخرون الجلوس ماكس  نحرز تقدما. في الواقع، والبعض لا.</p>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-7 col-lg-12">
                    <div class="about-style1-text-box text-right">
                        <div class="title">
                            <p>أهلا بك</p>
                            <h1>لنا <b>10</b> <span>RinBuild</span><br> <b>سنوات</b> العمل<br> تجربة.</h1>
                        </div>
                        <div class="inner-contant">
                            <p>وحتى الآن فقد كان الألم الحراري، وأحيانا حاملا Mauris زين. ولكن بعض لكرة السلة الآن. سلطة في الثلاجة، في أبجد في الاحماء، البوابة الحدودية تبدأ.  مما أدى إلى adipiscing الذاتية،</p>
                            <p>وحتى الآن فقد كان الألم الحراري، وأحيانا حاملا Mauris زين. ولكن بعض لكرة السلة الآن. سلطة في الثلاجة، في أبجد في الاحماء، البوابة الحدودية تبدأ.</p>
    ...
    <section class="service-style2-area">
        ...
        <div class="container service-box">
            <div class="sec-title text-center">
                <p>نحن خبير في</p>
                <div class="big-title"><h1>خدمات الشركة</h1></div>
            </div>
            <div class="row">
                            ...
                            <div class="overlay-content">
                                <div class="inner-content">
                                    ...
                                    <div class="text-holder">
                                        ...
                                        <p>أبجد هوز دولور الجلوس امات، دولور الجلوس امات إيليت. لأنهم لا انحني اجلالا واكبارا، هو الألم هوز دولور الجلوس امات.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="all-service-button text-center">
                        <a class="btn-one" href="#">جميع خدماتنا</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="latest-portfolio-area">
        <div class="container">
            <div class="sec-title text-center">
                <p>صناعات العمل العالمية لدينا!</p>
                <div class="big-title black-clr"><h1>أحدث محفظة</h1></div>
            </div>
            <div class="row">
                <div class="col-xl-12">
                    <div class="project-menu-box wow fadeInUp" data-wow-delay="100ms" data-wow-duration="1500ms">
                        <ul class="project-filter clearfix post-filter has-dynamic-filters-counter">
                            <li data-filter=".filter-item" class="active"><span class="filter-text"><i class="flaticon-menu"></i>جميع الحالات</span></li>
                            <li data-filter=".build"><span class="filter-text"><i class="flaticon-building"></i>البنايات</span></li>
                            <li data-filter=".bridge"><span class="filter-text"><i class="flaticon-modern-bridge-road-symbol"></i>الجسر الحديث</span></li>
                            <li data-filter=".houses"><span class="filter-text"><i class="flaticon-house"></i>منازل</span></li>
                            <li data-filter=".interior"><span class="filter-text"><i class="flaticon-chair"></i>الداخلية</span></li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="row filter-layout masonary-layout">
                    ...
                    <div class="single-portfolio-style1">
                        <div class="img-holder">
                            ...
                            <div class="title-holder">
                                <span class="tag">بناء</span>
                                <h5><a href="#">بناء المدينة الرياضية</a></h5>
                                <p><span class="flaticon-location-pin"></span>KA-62/1 ، كوريل ، بروغوتي</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item bridge interior">
                    <div class="single-portfolio-style1">
                        <div class="img-holder">
                            <div class="inner-box">
                                <img src="assets/images/portfolio/portfolio-v1-4.jpg" alt="Awesome Image">
                                <div class="overlay-style-one">
                                    <div class="box">
                                        <div class="inner">
                                            <div class="zoom-button">
                                                <a class="lightbox-image" data-fancybox="gallery" href="assets/images/portfolio/portfolio-v1-4.jpg">
                                                    <span class="flaticon-plus"></span>
                                                </a>
                                            </div>
                                        </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item build houses">
                    <div class="single-portfolio-style1">
                        <div class="img-holder">
                            <div class="inner-box">
                                <img src="assets/images/portfolio/portfolio-v1-5.jpg" alt="Awesome Image">
                                <div class="overlay-style-one">
                                    <div class="box">
                                        <div class="inner">
                                            <div class="zoom-button">
                                                <a class="lightbox-image" data-fancybox="gallery" href="assets/images/portfolio/portfolio-v1-5.jpg">
                                                    <span class="flaticon-plus"></span>
                                                </a>
                                            </div>
                                        </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item build houses">
                    <div class="single-portfolio-style1">
                        <div class="img-holder">
                            <div class="inner-box">
                                <img src="assets/images/portfolio/portfolio-v1-6.jpg" alt="Awesome Image">
                                <div class="overlay-style-one">
                                    <div class="box">
                                        <div class="inner">
                                            <div class="zoom-button">
                                                <a class="lightbox-image" data-fancybox="gallery" href="assets/images/portfolio/portfolio-v1-6.jpg">
                                                    <span class="flaticon-plus"></span>
                                                </a>
                                            </div>
                                        </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="all-portfolio-button text-center">
                        <a class="btn-one" href="#">لدينا جميع محفظة</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="testimonial-style1-area home_rtl">
        <div class="container">
            <div class="row">
                <div class="col-xl-6">
                    <div class="testimonial-style1-title-box" data-aos="fade-right" data-aos-easing="linear" data-aos-duration="700">
                        <div class="sec-title">
                            <p>صناعات العمل العالمية لدينا!</p>
                            <div class="big-title"><h1>ما عملائنا يقول ملاحظات؟</h1></div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-6">
                    <div class="single-vertical-carousel">
                        <div class="slide">
                            ...
                            <div class="single-testimonial-style1">
                                <div class="text">
                                    <p>حتى الخميرة قبيحة على قيد الحياة. لا يوجد أي موظف العقارات سهلا. لا يوجد لينة البيئي وليس على السعر المحدد الآن في  لا يوجد أي موظف العقارات سهلا. على قيد الحياة. لا يوجد أي موظف العقارات سهلا.</p>
                                </div>
                        ...
                        <div class="slide">
                            ...
                            <div class="single-testimonial-style1">
                                <div class="text">
                                    <p>حتى الخميرة قبيحة على قيد الحياة. لا يوجد أي موظف العقارات سهلا. لا يوجد أي موظف العقارات سهلا. لا يوجد لينة البيئي وليس على السعر المحدد الآن في  على قيد الحياة. لا يوجد أي موظف العقارات سهلا.</p>
                                </div>
                                <div class="client-info">
                                    <div class="icon-box">
                                        <span class="flaticon-engineer-1"></span>
    ...
    <section class="team-area">
        <div class="container">
            <div class="sec-title text-center">
                <p>التق بفريقنا</p>
                <div class="big-title black-clr"><h1>فريق الخبراء لدينا</h1></div>
            </div>
            <div class="row">
    ...
    <section class="latest-blog-area">
        <div class="container">
            <div class="sec-title text-center">
                <p>مدونتنا</p>
                <div class="big-title black-clr"><h1>أحدث المشاركات لدينا</h1></div>
            </div>
            <div class="row">
                <!--Start single blog post-->
                <div class="col-xl-7 col-lg-12 col-md-12 col-sm-12">
                    <div class="single-blog-post text-right wow fadeInUp animated" data-wow-delay="0.3s" data-wow-duration="1200ms">
                        <div class="img-holder">
                        ...
                        <div class="text-holder">
                            <h3 class="blog-title"><a href="blog-single.html">لأنه ليست كبيرة أنه ليست كبيرة لا الأصول تجمع الواجبات المنزلية.</a></h3>
                            <p>في الواقع، شرفة كبيرة من حركة المرور، ولكن لينة، وسعر التمويل. Mauris التغذية الكلي، ولكن خارقة تشغيل كرة القدم. دائما كرة القدم الحرة في كرة السلة أمام، يحتاج الآن جعبة تنورة.</p>
                            <div class="bottom">
                                <div class="author-name">
                                    <a href="#"><span class="flaticon-user"></span>ريشي مومو</a>
                                </div>
                                <div class="read-more-button">
                                    <a href="blog-single.html">اقرأ أكثر<span class="flaticon-next"></span></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-5 col-lg-12 col-md-12 col-sm-12">
                    <div class="single-blog-post style2 text-right wow fadeInUp animated" data-wow-delay="0.4s" data-wow-duration="1300ms">
                        <div class="img-holder">
                            <img src="assets/images/blog/blog-v2-1.jpg" alt="Awesome Image">
                            <div class="overlay-style-one bg1"></div>
                            <div class="post-date">
                                <p><span class="flaticon-clock"></span>20/10/19</p>
                            </div>
                        ...
                        <div class="text-holder">
                            <h3 class="blog-title"><a href="blog-single.html">الحوار الاقتصادي الاستراتيجي  الاستراتيجي الاستراتيجي اعتصام  امات أورسي   سعر ثمن ذلك. لكل منهما.</a></h3>
                        </div>
                    </div>
                    <div class="single-blog-post style2 text-right wow fadeInUp animated" data-wow-delay="0.5s" data-wow-duration="1400ms">
                        <div class="img-holder">
                            <img src="assets/images/blog/blog-v2-2.jpg" alt="Awesome Image">
                            <div class="overlay-style-one bg1"></div>
                            <div class="post-date">
                                <p><span class="flaticon-clock"></span>20/10/19</p>
                            </div>
                        ...
                        <div class="text-holder">
                            <h3 class="blog-title"><a href="blog-single.html">لحوار الاقتصادي الاستراتيجي  الاستراتيجي الاستراتيجي اعتصام  امات أورسي   سعر ثمن ذلك. لكل منهما.</a></h3>
                        </div>
                    </div>
                </div>
                <!--End single blog post-->
